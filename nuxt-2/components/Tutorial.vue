  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold" v-t:welcome-title>
          {{ $t('welcome-title') }}
        </h2>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a href="https://nuxtjs.org" target="_blank" class="text-green-500 hover:underline">Nuxt documentation</a>, whether you are new or have previous experience with the framework.
        </p>
...
<fluent locale="en">
welcome-title = Welcome to your Nuxt Application
</fluent>

<fluent locale="uk">
welcome-title = Ласкаво просимо до вашого Nuxt Додатку
</fluent>
